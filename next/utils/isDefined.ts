...
export type WithTypename<Type extends ObjWithTypename> = WithRequired<Type, '__typename'>
...
export function isError<T extends ObjWithTypename>(
  value: T | { __typename: 'Error' } | null | undefined
): value is ObjWithTypenameError {
