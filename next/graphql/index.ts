...
export const PreviewsByTagsDocument = gql`
  ...
  contentPages(
    ...
    sort: ["dateTo:desc", "publishedAt:desc"]
  ) {
    data {
      ...SectionItemEntity
    }
