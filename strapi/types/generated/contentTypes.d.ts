...
export interface ApiContactCardContactCard extends Schema.CollectionType {
  ...
  attributes: {
    createdAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::contact-card.contact-card', 'oneToOne', 'admin::user'> &
      Attribute.Private
    email: Attribute.Email &
    ...
    updatedAt: Attribute.DateTime
    updatedBy: Attribute.Relation<'api::contact-card.contact-card', 'oneToOne', 'admin::user'> &
      Attribute.Private
  }
}
...
export interface ApiContentPageContentPage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::content-page.content-page', 'oneToOne', 'admin::user'> &
      Attribute.Private
    ...
    place: Attribute.Relation<'api::content-page.content-page', 'manyToOne', 'api::place.place'>
    ...
    tags: Attribute.Relation<'api::content-page.content-page', 'manyToMany', 'api::tag.tag'>
    ...
    updatedAt: Attribute.DateTime
    updatedBy: Attribute.Relation<'api::content-page.content-page', 'oneToOne', 'admin::user'> &
      Attribute.Private
...
export interface ApiPlacePlace extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >
    createdAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::place.place', 'oneToOne', 'admin::user'> & Attribute.Private
    locale: Attribute.String
    localizations: Attribute.Relation<'api::place.place', 'oneToMany', 'api::place.place'>
    purchaseId: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false
    ...
    updatedAt: Attribute.DateTime
    updatedBy: Attribute.Relation<'api::place.place', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiTagCategoryTagCategory extends Schema.CollectionType {
  ...
  attributes: {
    createdAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::tag-category.tag-category', 'oneToOne', 'admin::user'> &
      Attribute.Private
    locale: Attribute.String
    localizations: Attribute.Relation<
    ...
    tags: Attribute.Relation<'api::tag-category.tag-category', 'oneToMany', 'api::tag.tag'>
    title: Attribute.String &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
    ...
    updatedAt: Attribute.DateTime
    updatedBy: Attribute.Relation<'api::tag-category.tag-category', 'oneToOne', 'admin::user'> &
      Attribute.Private
  }
}
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    contentPages: Attribute.Relation<'api::tag.tag', 'manyToMany', 'api::content-page.content-page'>
    createdAt: Attribute.DateTime
    ...
    tagCategory: Attribute.Relation<'api::tag.tag', 'manyToOne', 'api::tag-category.tag-category'>
    title: Attribute.String &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiTicketTicket extends Schema.CollectionType {
  ...
  attributes: {
    createdAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::ticket.ticket', 'oneToOne', 'admin::user'> &
      Attribute.Private
    ...
    locale: Attribute.String
    localizations: Attribute.Relation<'api::ticket.ticket', 'oneToMany', 'api::ticket.ticket'>
    ...
    updatedAt: Attribute.DateTime
    updatedBy: Attribute.Relation<'api::ticket.ticket', 'oneToOne', 'admin::user'> &
      Attribute.Private
  }
}
