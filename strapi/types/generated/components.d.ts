...
export interface BlocksMenuLinkItem extends Schema.Component {
  ...
  attributes: {
    ...
    mainPage: Attribute.Relation<'blocks.menu-link-item', 'oneToOne', 'api::main-page.main-page'>
    title: Attribute.String & Attribute.Required
    url: Attribute.String
  }
}
...
export interface BlocksPartnerItem extends Schema.Component {
  ...
  attributes: {
    partner: Attribute.Relation<'blocks.partner-item', 'oneToOne', 'api::partner.partner'>
  }
}
...
export interface SectionsArchiveBannerSection extends Schema.Component {
  ...
  attributes: {
    banner: Attribute.Component<'blocks.exhibition-archive'> & Attribute.Required
